...
$modals = CIBlockElement::GetList(array("ID"=>"DESC"), Array('IBLOCK_ID' => 10, 'ACTIVE' => 'Y'), false, array('nPageSize'=> $per_page,'iNumPage' => $page),
...
<?php
if ($modals->NavRecordCount <= (($page - 1)*$per_page)){
    die();
}
?>
