...
?>
		...
		<li class="authorization-social__item">
			<a id="bx_socserv_icon_<?=$service["ID"]?>" class="social social_google" href="javascript:void(0)" onclick="<?=\Bitrix\Main\Text\HtmlFilter::encode($onclick)?>" title="<?=\Bitrix\Main\Text\HtmlFilter::encode($service["NAME"])?>">
                <img src="<?= SITE_TEMPLATE_PATH ?>/img/<?=$service["ICON"]?>.svg" alt="">
            </a>
