                ...
                <div class="banner-template__content">
                    <div class="banner-template__text">
                        ...
                        <? $reviews = CIBlockElement::GetList(array("ID" => "DESC"), array('IBLOCK_ID' => 10, 'ACTIVE' => 'Y'), false, array('nPageSize'=> 8,'iNumPage' => 1),
                            array('ID', 'PROPERTY_igra', 'PROPERTY_name', 'PROPERTY_zvezdi', 'PROPERTY_otziv', 'PROPERTY_foto', 'PROPERTY_tema', 'TIMESTAMP_X')); ?>
                        <h1 class="banner-template__title title">Отзывы</h1>
                        <div class="banner-template__subtitle">Получено
                            <span><?= $reviews->NavRecordCount ?></span> отзыва на сайте
                        </div>
                        <div class="banner-template__group">
                            <a href="#" class="banner-all-reviews-filter btn border">Все игры</a>
                            <a href="/otzyvy/ostavit_otziv" class="banner-template__btn btn">Оставить отзыв</a>
                        </div>
                    </div>
        ...
        <section class="all-reviews">
            <div class="container">
                <div class="all-reviews__content" id="allreviews">
                    ...
                    <div class="box swiper-slide reviews-slider__item review-modal-up"
                         data-modal="<?= $review['ID'] ?>">
                    ...
                    <button id="button" class="all-reviews__more btn">Загрузить еще</button>
    ...
    <div class="popup-wrap">
        <div class="popup-content all-reviews">
            <div class="popup-close">
                <img class="close-response" data-close="<?= $modal['ID'] ?>"
                     src="<?= SITE_TEMPLATE_PATH ?>/img/delete.svg" alt="">
            </div>

            <div class="swiper-slide reviews-item border border-b">
                <div class="popup-title">Отзывы о нашей компании</div>
                <div class="reviews-slider__item-wrap">
                    <?php
                    ...
                    <div class="reviews-slider__author empty">
                        ...
                        <div class="reviews-slider__text">
                            ...
                            <div class="reviews-slider__service"><?= $modal['PROPERTY_IGRA_VALUE'] ?></div>
                        </div>
                    </div>
